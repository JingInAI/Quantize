...
class PromptLearner(nn.Module):
    def __init__(
        ...
        self.init_ctx_vectors = ctx_vectors.detach().clone()
    ...
    def reset(self):
        self.ctx.copy_(self.init_ctx_vectors)
...
class CoOp(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.prompt_learner = PromptLearner(classnames, clip_model, n_ctx, ctx_init, csc, ctx_position)
